...
def clean_data(gt_anno, dt_anno, current_class, difficulty):
    ...
    # Parameters for easy, moderate and hard difficulty
    ...
    for i in range(num_dt):
        if (dt_anno['name'][i].lower() == current_cls_name):
            ...
            valid_class = -1
        height = 100 #abs(dt_anno['bbox'][i, 3] - dt_anno['bbox'][i, 1])
...
def carla_eval(gt_annos,
               dt_annos,
               current_classes,
               eval_types=['bbox', 'bev', '3d']):
    """Evaluation for three classes: pedestrian, cyclist, car.
    ...
    overlap_0_7 = np.array([[0.5, 0.5, 0.7],
                            [0.5, 0.5, 0.7],
                            [0.5, 0.5, 0.7]])
    overlap_0_5 = np.array([[0.5, 0.5, 0.7],
                            [0.25, 0.25, 0.5],
                            [0.25, 0.25, 0.5]])
...
def carla_eval_coco_style(gt_annos, dt_annos, current_classes):
